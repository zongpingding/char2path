...
\begin{example}
\def\ctpL{\chartoclip[font=lmr, image=example-image]{L}}
\def\ctpA{\chartoclip[font=lmr, image=example-image]{A}}
\def\ctpT{\chartoclip[font=lmr, image=example-image]{T}}
\def\ctpE{\chartoclip[font=lmr, image=example-image]{E}}
\def\ctpX{\chartoclip[font=lmr, image=example-image]{X}}
