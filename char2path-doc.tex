...
\begin{function}{\charfading}
  ...
  to path.
  \begin{keyval}
    \item [\key{fading}] \val{clist} can set the two colors and one direction for fading.
  \end{keyval}
\end{function}
...
\begin{example}
  \chartopath[path fading = west,
              fill = blue] {0123456789}
\end{example}
they will found that every character fading discretely.
If they want to fading the whole strings, not fading one by one,
then use this module

\begin{example}
  \charfading[fading = {red, green, horizontal}]
    {0123456789}
\end{example}

\begin{example}
  \charfading[fading = {violet, blue, horizontal}]
    {0123456789}
\end{example}

\begin{example}
  \charfading[fading = {green, red, horizontal}]
    {0123456789}
\end{example}

\begin{example}
  \charfading[fading = {blue, violet, horizontal}]
    {0123456789}
\end{example}

\begin{example}
  \charfading[fading = {teal, violet, vertical}]
    {0123456789}
\end{example}

\begin{example}
  \charfading[fading = {violet, teal, vertical}]
    {0123456789}
\end{example}
