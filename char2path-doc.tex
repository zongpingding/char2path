...
\begin{example}
  \chartopath[pattern = north west lines,
              draw = black, scale = 2.5] {0123456789}
\end{example}

FakeSlant is also supported

\begin{example}
  \chartopath[draw = red, fill = green, xslant = .15,
              scale = 2.5] {0123456789} [lmm]
\end{example}
...
\begin{example}
  \charfading[colorset = {teal, violet},
              direction = vertical] {0123456789}
\end{example}

\begin{example}
  \charfading[colorset = {violet, teal},
              direction = vertical] {0123456789}
\end{example}
