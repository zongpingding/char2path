...
\ExplSyntaxOff
\strpathclip[scale = 2, font = lmr]{Hello} \strpathclip[scale = 2, font = lmm]{c2p}
\end{example}
...
\subsection{Get path data}

\begin{example*}
  \def\0{\ctpdata{lmr}{-}} \ttfamily\nobreakdash\detokenize\expandafter{\expanded{\0}}
\end{example*}
